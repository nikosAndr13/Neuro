  ...
  switch (result.level) {
    ...
    case "dysregulated":
      return {
        ...
        ctaTitle: "Emergency Nervous System Reset",
        ctaDescription:
          "Get the intensive support you need to break free from chronic dysregulation and reclaim your life with our comprehensive healing program.",
        color: "red",
        graphColor: "#dc2626",
      };
  }
